...
public class Organization extends TableImpl<OrganizationRecord> {
    ...
    private static final long serialVersionUID = 1022279945;
     ...
     */
    public final TableField<OrganizationRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.Organization.inn</code>.
     */
    public final TableField<OrganizationRecord, Integer> INN = createField("inn", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.Organization.payment_account</code>.
     */
    public final TableField<OrganizationRecord, Long> PAYMENT_ACCOUNT = createField("payment_account", org.jooq.impl.SQLDataType.BIGINT, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.NAME_PK);
    }
    ...
    public List<UniqueKey<OrganizationRecord>> getKeys() {
        return Arrays.<UniqueKey<OrganizationRecord>>asList(Keys.NAME_PK);
    }
